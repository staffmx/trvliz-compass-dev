        ...
        <div className="max-w-site mx-auto px-mobile-x relative z-10">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-8 md:gap-16">
            ...
            <div className="flex-1">
              <span className={`inline-block px-4 py-1.5 rounded-none text-[10px] font-bold uppercase tracking-[2px] border mb-6 ${
                event.type === 'Webinar' ? 'bg-purple-900/40 text-purple-200 border-purple-500/30' : 
                ...
                <div className="relative z-10">
                    ...
                    {event.link ? (
                        ...
                        <button 
                            ...
                            className={`w-full py-4 font-bold uppercase tracking-widest text-[11px] transition-all shadow-xl flex items-center justify-center gap-2 ${
                              isRegistered 
                    ...
                    <p className="mt-6 text-[10px] text-gray-400 text-center uppercase tracking-widest italic">
                        Cupo limitado para miembros elite
                    </p>
                </div>
            </div>

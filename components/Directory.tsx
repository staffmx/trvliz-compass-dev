...
const Directory: React.FC = () => {
  ...
  return (
    // Base layout mimicking .traveliz-directory
          ...
          <div className="flex justify-center">
            <div className="relative w-full max-w-[600px]">
                <input
                    ...
                    placeholder="Buscar asociada por nombre o email..."
      ...
      {loading ? (
          ...
          <>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 mb-16">
                ...
                >
                    {/* Photo Wrapper - SQUARE IMAGE (aspect-square) */}
                    <div className="w-full aspect-square overflow-hidden bg-[#F5F1E8]">
                    <img 
                        src={associate.image} 
                        alt={associate.name} 
                        // Image Styles: Grayscale default, Color on Hover.
                    ...
                    {/* Info Section - Reduced padding for 5-col layout */}
                    ...
                    {/* Details Link with Underline Animation */}
                    <div>
                        <button className="text-[10px] tracking-[2px] uppercase font-bold text-accent inline-block relative group/btn">
                            Ver Perfil
                ...
                {filteredAssociates.length === 0 && (
                    <div className="col-span-full text-center py-20 text-secondary">
                        ...
                        <p>No se encontraron asociadas con ese nombre.</p>
                    </div>
                )}
            </div>
